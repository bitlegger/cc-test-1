...
Test project of coockiecutter django template
...
.. code-block:: bash
    ...
    heroku run python cc-test-1/manage.py syncdb --noinput --settings=config.settings
    heroku run python cc-test-1/manage.py migrate --settings=config.settings
    heroku run python cc-test-1/manage.py collectstatic --settings=config.settings
